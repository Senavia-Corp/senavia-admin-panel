...
import { NewUserProfileTab } from "@/components/organisms/new-user-profile-tab"
import { NewUserRequestsTab } from "@/components/organisms/new-user-requests-tab"
import { NewUserProjectsTab } from "@/components/organisms/new-user-projects-tab"
...
export function UsersPage() {
  ...
  const loadUsers = async () => {
    try {
      const usersData = await UserManagementService.getUsers(searchTerm, roleFilter)
      setUsers(usersData)
    } catch (error) {
        ...
        <main className="flex-1 overflow-hidden">
          <div className="px-6 py-6 h-full w-screen max-w-none">
            <NewUserDetailTabs onBack={() => setSelectedUser(null)}>
              <NewUserProfileTab tabName="Profile Info" user={selectedUser} />
              <NewUserRequestsTab tabName="Requests" userId={selectedUser.id} />
              <NewUserProjectsTab tabName="Projects" userId={selectedUser.id} />
            </NewUserDetailTabs>
          </div>
        </main>
      </div>
      ...
      <main className="flex-1 bg-gray-50 overflow-auto">
        <div className="p-6 h-full w-full">
          <div className="flex flex-col h-full w-full">
            <h1 className="text-2xl font-bold text-gray-900 mb-6 flex-shrink-0">User Management</h1>
