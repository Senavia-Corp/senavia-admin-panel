...
export function ContractsPage() {
  ...
  const loadContracts = async () => {
    try {
      const contractsData = await ContractManagementService.getContracts(searchTerm, statusFilter)
  ...
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden">
      ...
      <main className="flex-1 bg-gray-50 overflow-auto">
        <div className="p-6 h-full w-full">
          <div className="flex flex-col h-full w-full">
            <h1 className="text-2xl font-bold text-gray-900 mb-6 flex-shrink-0">Contract Management</h1>
      ...
      <DeleteConfirmDialog
        ...
        onConfirm={() => contractToDelete && handleDeleteContract(contractToDelete)}
