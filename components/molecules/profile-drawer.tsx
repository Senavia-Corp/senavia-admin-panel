   ...
   useEffect(() => {
    fetch("http://localhost:3000/api/auth/me", {
      ...
      .then(data => {
        ...
        console.log("Soy data.name: "+data.data.name)
        console.log("Soy user: "+user.name)
      })
      .catch(err => {
      ...
      <div className="fixed right-0 top-0 h-full w-[320px] bg-white shadow-xl overflow-y-auto">
        <div className="flex flex-col items-center justify-between h-full py-8">
          ...
          <div className="flex flex-col items-center relative border-none">
            ...
            <h2 className="text-2xl font-semibold mb-1 text-black">{user.name || 'Usuario'}</h2>
            <div className="flex flex-col items-center text-sm text-black">
              <div className="flex items-center gap-1 mb-1">
                ...
                <p className="font-light">{user.email || 'Usuario@gmail.com'}</p>
              </div>
              <div className="flex items-center gap-1 mb-1">
